...
if not redis:get(Titan..'lock_geams'..msg.chat_id_) then 
return "🙋🏼‍♂️*╿* أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* الالعاب بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(Titan..'lock_geams'..msg.chat_id_) 
return "🙋🏼‍♂️*╿* أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تفعيل الالعاب \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "الالعاب" or MsgText[2] == "اللعبه" or MsgText[2] == "اللعبة" then
if not msg.Admin then return "📛*│* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if redis:get(Titan..'lock_geams'..msg.chat_id_) then 
return "🙋🏼‍♂️*╿* أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* الالعاب بالتأكيد معطله\n✓" 
else
redis:set(Titan..'lock_geams'..msg.chat_id_,true)  
return "🙋🏼‍♂️*╿* أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تعطيل الالعاب\n✓" 
end   
end
...
redis:set(Titan..'SET:ID:USER'..msg.chat_id_,ID_USER)  
redis:setex(Titan.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
...
local ID_USER = MsgText[2]
redis:set(Titan..'SET:ID:USER:NUM'..msg.chat_id_,ID_USER)  
redis:setex(Titan.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_,500,true)  
sendMsg(msg.chat_id_,msg.id_,'*📊│ارسل لي عدد النقاط الذي تريده*')
end
if not redis:get(Titan..'lock_geams'..msg.chat_id_) and msg.GroupActive then
if MsgText[1] == 'اسئله' or MsgText[1] == 'ختيارات' or MsgText[1] == 'بدء الاسئله' then   
redis:set(Titan.."GAME:S"..msg.chat_id_,true) 
t1 = [[
...
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'النيل') 
elseif SENDTEXT:find('14') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'14') 
elseif SENDTEXT:find('الفم') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'الفم') 
elseif SENDTEXT:find('11') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'11') 
elseif SENDTEXT:find('30') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'30') 
elseif SENDTEXT:find('بوتين') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'بوتين') 
elseif SENDTEXT:find('ستيف جوبر') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'ستيف جوبر') 
elseif SENDTEXT:find('باريس') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'باريس') 
elseif SENDTEXT:find('10') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'10') 
elseif SENDTEXT:find('النمل') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'النمل') 
elseif SENDTEXT:find('حرف الواو') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'حرف الواو') 
elseif SENDTEXT:find('الشعر') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'الشعر') 
elseif SENDTEXT:find('ابراهيم') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'ابراهيم') 
elseif SENDTEXT:find('سحاب') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'سحاب') 
elseif SENDTEXT:find('الاسم') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'الاسم') 
elseif SENDTEXT:find('ذهب') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'ذهب') 
elseif SENDTEXT:find('حرف الام') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'حرف الام') 
elseif SENDTEXT:find('العزائم') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'العزائم') 
elseif SENDTEXT:find('انسات') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'انسات') 
elseif SENDTEXT:find('المنجنيق') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'المنجنيق') 
elseif SENDTEXT:find('اسيا') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'اسيا') 
elseif SENDTEXT:find('الاسد') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'الاسد') 
elseif SENDTEXT:find('6') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'6') 
elseif SENDTEXT:find('مهر') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'مهر') 
elseif SENDTEXT:find('الدلفين') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'الدلفين') 
elseif SENDTEXT:find('اوروبا') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'اوروبا') 
elseif SENDTEXT:find('الزئبق') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'الزئبق') 
elseif SENDTEXT:find('لندن') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'لندن') 
elseif SENDTEXT:find('الانسان') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'الانسان') 
elseif SENDTEXT:find('طوكيو') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'طوكيو') 
elseif SENDTEXT:find('خديجه') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'خديجه') 
end
...
redis:set(Titan..':Set_alii:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(Titan..':Set_Amthlh:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(Titan..':Set_Hzorh:'..msg.chat_id_,name)
...
Num = math.random(1,6)
redis:set(Titan.."GAMES"..msg.chat_id_,Num) 
TEST = [[
*➀       ➁     ➂      ➃      ➄     ➅
↓      ↓     ↓      ↓     ↓     ↓
👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊 ‹› 👊
...
redis:setex(Titan.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if MsgText[1] == 'خمن' or MsgText[1] == 'تخمين' then   
Num = math.random(1,20)
redis:set(Titan.."GAMES:NUM"..msg.chat_id_,Num) 
TEST = '*\n📮│اهلا بك عزيزي في لعبة التخمين :\nٴ━━━━━━━━━━\n'..'⚠│ملاحظه لديك { 3 } محاولات فقط فكر قبل ارسال تخمينك \n\n'..'🔖│سيتم تخمين عدد ما بين ال {1 و 20} اذا تعتقد انك تستطيع الفوز جرب واللعب الان ؟ \n💥*'
sendMsg(msg.chat_id_,msg.id_,TEST)
redis:setex(Titan.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 100, true)  
return false  
end
if (MsgText[1] == 'اسرع' or MsgText[1] == 'الاسرع') then
local NUM = math.random(10,1000)
redis:set(Titan..':NUM_SET:'..msg.chat_id_,(NUM * 3))
...
redis:set(Titan..':Set_Smile:'..msg.chat_id_,Emoji)
if tonumber(redis:get(Titan..':Set_Smile:'..msg.chat_id_)) == tonumber(redis:get(Titan..':NUM_SET:'..msg.chat_id_)) then
return '◀️┇اول من يكتب هذه العدد يفوز ؛  ››`'..(redis:get(Titan..':Set_Smile:'..msg.chat_id_))..'`'
else
return '️┇اول من يكتب هذه السمايل يفوز ››    `'..(redis:get(Titan..':Set_Smile:'..msg.chat_id_))..'`'
end
end
...
name = katu[math.random(#katu)]
redis:set(Titan..':Set_Arg:'..msg.chat_id_,name)
...
name = katu[math.random(#katu)]
redis:set(Titan..':Set_Name_Meant:'..msg.chat_id_,name)
...
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'فهمت') 
elseif SENDTEXT:find('مو جبان') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'مو جبان') 
elseif SENDTEXT:find('عدل') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'عدل') 
elseif SENDTEXT:find('نشط') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'نشط') 
elseif SENDTEXT:find('مو زين') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'مو زين') 
elseif SENDTEXT:find('مو عطشان') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'مو عطشان') 
elseif SENDTEXT:find('حاره') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'حاره') 
elseif SENDTEXT:find('مو خايف') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'مو خايف') 
elseif SENDTEXT:find('خلف') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'خلف') 
elseif SENDTEXT:find('وفي') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'وفي') 
elseif SENDTEXT:find('قزم') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'قزم') 
elseif SENDTEXT:find('لين') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'لين') 
elseif SENDTEXT:find('خشن') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'خشن') 
elseif SENDTEXT:find('عاقل') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'عاقل') 
elseif SENDTEXT:find('ذكي') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'ذكي') 
elseif SENDTEXT:find('مو ظلمه') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'مو ظلمه') 
elseif SENDTEXT:find('مو مسموح') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'مو مسموح') 
elseif SENDTEXT:find('اسمعك') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'اسمعك') 
elseif SENDTEXT:find('روح') then
redis:set(Titan.."GAME:CHER"..msg.chat_id_,'روح') 
end
sendMsg(msg.chat_id_,msg.id_,SENDTEXT)     
return false  
end
...
redis:decrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,MsgText[2])  
redis:incrby(Titan..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_,Total_Point)  
return "💰╿تم خصم {* "..MsgText[2].." *} من نقاطك\n📮│تم زياده {* "..Total_Point.."* } من الرسائل \n📑╽اصبحت رسائلك { *"..redis:get(Titan..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_).."* } رساله\n🔖"
end
end
if MsgText[1] == "الالعاب" or MsgText[1] == "اللعبه" or MsgText[1] == "اللعبة" then
return [[ 
🤡│•⊱ الالعاب لبوت []]..redis:get(Titan..':NameBot:')..[[]  ، ! 🎖
...
redis:del(Titan..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:del(Titan..':List_Rolet:'..msg.chat_id_)  
redis:setex(Titan..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_,3600,true)  
return '*🎪│* حسننا لنلعب , ارسل عدد اللاعبين للروليت .'
end
if MsgText[1] == 'نعم' and redis:get(Titan..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_) then
local list = redis:smembers(Titan..':List_Rolet:'..msg.chat_id_) 
if #list == 1 then 
...
redis:incrby(Titan..':User_Points:'..msg.chat_id_..data.id_,5)
end,nil)
redis:del(Titan..':List_Rolet:'..msg.chat_id_) 
redis:del(Titan..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_)
...
if msg.text and not redis:get(Titan..'lock_geams'..msg.chat_id_) then
if msg.text == redis:get(Titan..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(Titan..':Set_alii:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  🎁  احسنت اجابتك صحيحه   \n*   \n')
end

if msg.text == redis:get(Titan..':Set_Amthlh:'..msg.chat_id_) then -- // امثله
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(Titan..':Set_Amthlh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  🎁  احسنت اجابتك صحيحه   \n*   \n')
end

if msg.text == redis:get(Titan..':Set_Hzorh:'..msg.chat_id_) then -- // حزوره
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(Titan..':Set_Hzorh:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  🎁  احسنت اجابتك صحيحه   \n*   \n')
end


if msg.text == redis:get(Titan..':Set_Smile:'..msg.chat_id_) then --//  الاسرع
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(Titan..':Set_Smile:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  🎊   احسنت اجابتك صحيحه \n*   \n')
end 
if msg.text == redis:get(Titan..':Set_alii:'..msg.chat_id_) then -- // المختلف
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
...
if msg.text == redis:get(Titan..':Set_Arg:'..msg.chat_id_) then -- // الترتيب
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(Titan..':Set_Arg:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*  🎁  احسنت اجابتك صحيحه   \n*   \n')
end 
if msg.text == redis:get(Titan..':Set_Name_Meant:'..msg.chat_id_) then --// المعاني
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(Titan..':Set_Name_Meant:'..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,'*   🎉   احسنت اجابتك صحيحه \n*   \n')
end 
if msg.text:match("^(%d+)$") and redis:get(Titan..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_) then  --// استقبال اللعبه الدمبله
if msg.text == "1" then
Text = "*📮│* لا استطيع بدء اللعبه بلاعب واحد فقط\n"
else
redis:set(Titan..":Number_Add:"..msg.chat_id_..msg.sender_user_id_,msg.text)  
Text = '💬╿تم بدء تسجيل اللسته \n💱│يرجى ارسال المعرفات \n🎊│الفائز يحصل على (5) مجوهره\n🎯╽عدد الاعبين المطلوبه { *'..msg.text..'* } لاعب \n 🏹'
end
redis:del(Titan..":Start_Rolet:"..msg.chat_id_..msg.sender_user_id_)  
return sendMsg(msg.chat_id_,msg.id_,Text)    
end
if msg.text:match('^(@[%a%d_]+)$') and redis:get(Titan..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) then    --// استقبال الاسماء
if redis:sismember(Titan..':List_Rolet:'..msg.chat_id_,msg.text) then
return sendMsg(msg.chat_id_,msg.id_,'*📮│* المعرف {['..msg.text..']} موجود اساسا' )
end
redis:sadd(Titan..':List_Rolet:'..msg.chat_id_,msg.text)
local CountAdd = redis:get(Titan..":Number_Add:"..msg.chat_id_..msg.sender_user_id_)
local CountAll = redis:scard(Titan..':List_Rolet:'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
redis:del(Titan..":Number_Add:"..msg.chat_id_..msg.sender_user_id_) 
redis:setex(Titan..":Witting_StartGame:"..msg.chat_id_..msg.sender_user_id_,1400,true)  
...
if redis:get(Titan.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_) then 
...
redis:del(Titan.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(Titan..'SET:ID:USER'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n📬*│روح خالي 😉 تم اضافة له { "..msg.text.." }* رساله")
redis:incrby(Titan..'msgs:'..GET_IDUSER..':'..msg.chat_id_,msg.text)  
end
redis:del(Titan.."SETEX:MSG"..msg.chat_id_..""..msg.sender_user_id_)  
end
if redis:get(Titan.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_) then 
if msg.text:match("^(%d+)$") then
if tonumber(msg.text:match("^(%d+)$")) > 99999999990 then
sendMsg(msg.chat_id_,msg.id_,"*📬│لا تستطيع اضافة اكثر من 99999999990 نقطه\n*")   
redis:del(Titan.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
return false  end 
local GET_IDUSER = redis:get(Titan..'SET:ID:USER:NUM'..msg.chat_id_)  
sendMsg(msg.chat_id_,msg.id_,"\n📬*│طكو طكو عمي 😻 تم اضافة له { "..msg.text.." }* نقطه")
redis:incrby(Titan..':User_Points:'..msg.chat_id_..GET_IDUSER,msg.text)  
end
redis:del(Titan.."SETEX:NUM"..msg.chat_id_..""..msg.sender_user_id_)  
end
if redis:get(Titan.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 6 then
sendMsg(msg.chat_id_,msg.id_,"*📬│عذرا لا يوجد سواء { 6 } اختيارات فقط ارسل اختيارك مره اخره*\n")   
return false  end 
local GETNUM = redis:get(Titan.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(Titan.."SET:GAME" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
sendMsg(msg.chat_id_,msg.id_,'*📮╿مبروك فزت وطلعت المحيبس بل ايد رقم { '..NUM..' }\n🎊╽لقد حصلت على { 3 }من نقاط يمكنك استبدالهن برسائل *')   
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,3)  
...
if (msg.text == redis:get(Titan.."GAME:CHER"..msg.chat_id_)) and redis:get(Titan.."GAME:S"..msg.chat_id_) then  
sendMsg(msg.chat_id_,msg.id_,'📮│اجابتك صحيحه ذكي وربي 😙')     
redis:incrby(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_,1)  
redis:del(Titan.."GAME:S"..msg.chat_id_)
redis:del(Titan.."GAME:CHER"..msg.chat_id_)
...
if redis:get(Titan.."GAME:S"..msg.chat_id_) then  
...
if redis:get(Titan.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then  
if msg.text:match("^(%d+)$") then
local NUM = msg.text:match("^(%d+)$")
if tonumber(NUM) > 20 then
sendMsg(msg.chat_id_,msg.id_,"*📬│عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 } *\n")
return false  end 
local GETNUM = redis:get(Titan.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
redis:del(Titan..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(Titan.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
redis:incrby(Titan..':User_Points:'..msg.chat_id_..data.id_,5)
sendMsg(msg.chat_id_,msg.id_,'*🔖╿مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸╽تم اضافة { 5 } من النقاط *\n')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
redis:incrby(Titan..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(redis:get(Titan..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
redis:del(Titan..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
redis:del(Titan.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
...
if redis:get(Titan.."chencher"..msg.sender_user_id_) then 
if redis:get(Titan.."chencher"..msg.sender_user_id_) ~= data.first_name_ then 
tahan = '['..(redis:get(Titan.."chencher"..msg.sender_user_id_) or '')..']'
...
redis:set(Titan.."chencher"..msg.sender_user_id_, data.first_name_) 
end,nil) 
end
end
return {
