...
redis:setex(Titan..":ZhrfNow:"..msg.sender_user_id_,500,true)
sendMsg(msg.chat_id_,msg.id_,"📑| حسننا , الان يمكنك ارسال الاسم 💯")    
return false
end

if redis:get(Titan..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(Titan..":ZhrfNow:"..msg.sender_user_id_)
...
if msg.text and msg.type ~= "pv" and redis:get(Titan..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(Titan..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
