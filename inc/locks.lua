...
else redis:set(Titan..'lock_woring'..msg.chat_id_,true)
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(Titan..'lock_woring'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*التحذير بالتأكيد معطل\n✓" 
else
redis:del(Titan..'lock_woring'..msg.chat_id_) 
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(Titan..'lock_id'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*الايدي بالتأكيد معطل\n✓" 
else
redis:del(Titan..'lock_id'..msg.chat_id_) 
...
redis:set(Titan..'lock_id'..msg.chat_id_,true)  
...
else redis:set(Titan..'welcome:get'..msg.chat_id_,true)  
...
if not msg.Admin then return "💥*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(Titan..'welcome:get'..msg.chat_id_) then 
...
Titan..'mute_gif'..msg.chat_id_,true,
Titan..'mute_photo'..msg.chat_id_,true,
Titan..'mute_audio'..msg.chat_id_,true,
Titan..'mute_voice'..msg.chat_id_,true,
Titan..'mute_sticker'..msg.chat_id_,true,
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:del(
Titan..'lock_username'..msg.chat_id_,
Titan..'mute_gif'..msg.chat_id_,
Titan..'mute_photo'..msg.chat_id_,
Titan..'mute_audio'..msg.chat_id_,
Titan..'mute_voice'..msg.chat_id_,
Titan..'mute_sticker'..msg.chat_id_,
Titan..'mute_forward'..msg.chat_id_,
Titan..'mute_contact'..msg.chat_id_,
Titan..'mute_location'..msg.chat_id_,
Titan..'mute_document'..msg.chat_id_,
Titan..'lock_link'..msg.chat_id_,
Titan..'lock_tag'..msg.chat_id_,
Titan..'lock_edit'..msg.chat_id_,
Titan..'lock_spam'..msg.chat_id_,
Titan..'lock_bots'..msg.chat_id_,
Titan..'lock_webpage'..msg.chat_id_,
Titan..'mute_video'..msg.chat_id_,
Titan..':tqeed_video:'..msg.chat_id_,
Titan..':tqeed_photo:'..msg.chat_id_,
Titan..':tqeed_gif:'..msg.chat_id_,
Titan..':tqeed_fwd:'..msg.chat_id_,
Titan..':tqeed_link:'..msg.chat_id_,
Titan..'mute_inline'..msg.chat_id_
)
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽*تــ✓ــم فتح الكل  \n✓"
end
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(Titan..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(Titan..'mute_photo'..msg.chat_id_)
redis:set(Titan..':tqeed_photo:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(Titan..':tqeed_photo:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالصور بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..':tqeed_photo:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(Titan..':tqeed_video:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالفيديو بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(Titan..':tqeed_video:'..msg.chat_id_)
redis:set(Titan..':tqeed_video:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(Titan..':tqeed_video:'..msg.chat_id_) then
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(Titan..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد الممتحركه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(Titan..'mute_gif'..msg.chat_id_)
redis:set(Titan..':tqeed_gif:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(Titan..':tqeed_gif:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد المتحركه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..':tqeed_gif:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(Titan..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالتوجيه بالتأكيد تــ✓ــم قفله \n✓'
else
redis:del(Titan..'mute_forward'..msg.chat_id_)
redis:set(Titan..':tqeed_fwd:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(Titan..':tqeed_fwd:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد التوجيه بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..':tqeed_fwd:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if redis:get(Titan..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..':tqeed_link:'..msg.chat_id_,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(Titan..':tqeed_link:'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التقييد بالروابط بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..':tqeed_link:'..msg.chat_id_)
...
if redis:get(Titan..'lock_twasel') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التواصل بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:set(Titan..'lock_twasel',true)
...
if not redis:get(Titan..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تعطيله \n✓'
else
redis:del(Titan..'replay'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'replay'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الردود بالتاكيد تــ✓ــم تفعيله \n✓'
else 
redis:set(Titan..'replay'..msg.chat_id_,true)
...
if not msg.SudoBase then return "🚸*│*هذا الامر يخص المطور الاساسي فقط  \n💥" end
if not redis:get(Titan..'lock_service') then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم بالتاكيد تعطيل نظام البوت خدمي \n✓'
else
redis:del(Titan..'lock_service')
...
redis:set(Titan..'lock_service',true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'lock_link'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_link'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الروابط بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'lock_link'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الروابط \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك (#) بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'lock_tag'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التاك (#) \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_tag'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التاك(#) بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'lock_tag'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التاك (#) \n✓'
end
end
---------------Lock UserName-------------------
...
if redis:get(Titan..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المعرفات @ بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'lock_username'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_username'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*آلمـعرفآت بآلتآگيد تــ✓ــم فتحهآ @ \n✓'
else 
redis:del(Titan..'lock_username'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'lock_edit'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_edit'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التعديل بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'lock_edit'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التعديل \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(Titan..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'lock_spam'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_spam'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكلايش بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'lock_spam'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الكلايش \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'lock_flood'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_flood'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التكرار بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'lock_flood'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح التكرار \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'lock_bots'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_bots'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'lock_bots_by_kick'..msg.chat_id_)
redis:del(Titan..'lock_bots'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البوتات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'lock_join'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_join'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاضافه بالتاكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'lock_join'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الاضافه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتاكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'lock_markdown'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_markdown'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الماركدوان بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'lock_markdown'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'lock_webpage'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الويب \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_webpage'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الويب بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'lock_webpage'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الويب \n✓'
end
end
---------------Mute Gif-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_gif'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*المتحركه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_gif'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_gif'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_game'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_game'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الألعاب بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_game'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الألعاب \n✓'
end
end
---------------Mute Inline-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'mute_inline'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_inline'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الانلاين بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'mute_inline'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدرشه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الدردشه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_text'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الدردشه بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_text'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الدردشه \n✓'
end
end
---------------Mute photo-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_photo'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصور بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_photo'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصور \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_photo'..msg.chat_id_)then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_video'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الفيديو \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_video'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الفيديو يال��أكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_video'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الفيديو \n✓'
end
end
---------------Mute Audio-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_audio'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل البصمات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_audio'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البصمات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_audio'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح البصمات \n✓'
end
end
---------------Mute Voice-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if   redis:get(Titan..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'mute_voice'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الصوت \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_voice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الصوت بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'mute_voice'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الصوت \n✓'
end
end
---------------Mute Sticker-------------------
...
if   redis:get(Titan..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_sticker'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_sticker'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملصقات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_sticker'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_contact'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_contact'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*جهات الاتصال بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_contact'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_forward'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التوجيه بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_forward'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل التوجيه \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_forward'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'mute_location'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الموقع \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_location'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الموقع بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'mute_location'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الموقع \n✓'
end
end
---------------Mute Document-------------------
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم قفلها \n✓'
else
redis:set(Titan..'mute_document'..msg.chat_id_,true)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم قفل الملفات \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_document'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الملفات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_document'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تــ✓ــم فتح الملفات \n✓'
end
end
---------------Mute TgService-------------------
...
redis:set(Titan..'mute_tgservice'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_tgservice'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الاشعارات بالتأكيد تــ✓ــم فتحها \n✓'
else 
redis:del(Titan..'mute_tgservice'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'mute_keyboard'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكيبورد بالتأكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'mute_keyboard'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'mute_keyboard'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*الكيبورد بالتأكيد تــ✓ــم فتحه \n✓'
else 
redis:del(Titan..'mute_keyboard'..msg.chat_id_)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_bots_by_kick'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*البوتات بالطرد بالتاكيد تــ✓ــم قفله \n✓'
else
redis:set(Titan..'lock_bots'..msg.chat_id_,true)
redis:set(Titan..'lock_bots_by_kick'..msg.chat_id_,true)
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_bots_by_kick'..msg.chat_id_) then
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if redis:get(Titan..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مقفل \n✓'
else
redis:set(Titan..'lock_pin'..msg.chat_id_,true) 
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تـم قفل التثبيت \n✓'
end
end
...
if not msg.Admin then return "📡*│*هذا الامر يخص الادمنيه فقط  💥" end
if not redis:get(Titan..'lock_pin'..msg.chat_id_) then
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*التثبيت بالفعل مفتوح \n✓'
else 
redis:del(Titan..'lock_pin'..msg.chat_id_)
return '🙋🏻‍♂*╿*أهلا عزيزي '..msg.TheRankCmd..'\n📡*╽*تـم فتح التثبيت   \n✓'
end
end
