...
redis:set(Titan.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(Titan..'lock:join:'..msg.chat_id_,true)
...
redis:del(Titan..'lock:join:'..msg.chat_id_)
return "*🙋🏼‍♂️*╿* أهلا عزيزي *"..msg.TheRankCmd.."*\n📡*╽* تم فتح الدخول بالرابط \n✓*" 
end


local function iTitan(msg,MsgText)

Channel = redis:get(Titan..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(Titan..'joinchnl') then
...
redis:setex(Titan..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(Titan..'CheckExpire::'..msg.chat_id_) then 
redis:set(Titan..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️│في مجموعه  » »  '..redis:get(Titan..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if MsgText[2] == '1' then
redis:setex(Titan..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(Titan..'CheckExpire::'..msg.chat_id_) then 
redis:set(Titan..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│تم تفعيل الاشتراك   👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️│تم تفعيل الاشتراك  👍🏿\n📆│ الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(Titan..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(Titan..'CheckExpire::'..msg.chat_id_) then 
redis:set(Titan..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(Titan..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(Titan..'CheckExpire::'..msg.chat_id_) then 
redis:set(Titan..'CheckExpire::'..msg.chat_id_,true) end
...
local check_time = redis:ttl(Titan..'ExpireDate:'..msg.chat_id_)
...
local GroupName = (redis:get(Titan..'group:name'..msg.chat_id_) or '')
redis:set(Titan..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(Titan..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. Titan..'')
...
if not msg.Director and redis:get(Titan..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(Titan..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not MsgText[2] and msg.reply_id then
if redis:get(Titan..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(Titan..'lock:kara:'..msg.chat_id_) == 'on' then
...
local Admins = redis:scard(Titan..'admins:'..msg.chat_id_)
redis:del(Titan..'admins:'..msg.chat_id_)
local NumMDER = redis:scard(Titan..'owners:'..msg.chat_id_)
redis:del(Titan..'owners:'..msg.chat_id_)
local MMEZEN = redis:scard(Titan..'whitelist:'..msg.chat_id_)
redis:del(Titan..'whitelist:'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(Titan..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(Titan..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(Titan..'ExCmdLink'..msg.chat_id_,120,true)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:setex(Titan..'linkGroup'..msg.sender_user_id_,300,true)
return '🔗│عزيزي قم برسال الرابط الجديد ...🍂'
end

if MsgText[1] == "الرابط" then
if not redis:get(Titan..'linkGroup'..msg.chat_id_) then 
return "📡*╿* اوه 🙀 لا يوجد رابط ☹️\n🔖*╽*لانشاء رابط ارسل { `انشاء رابط` }\n📡" 
end
local GroupName = redis:get(Titan..'group:name'..msg.chat_id_)
local GroupLink = redis:get(Titan..'linkGroup'..msg.chat_id_)
...
local Text = "🔖╿رابـط الـمـجـمـوعه 💯\n🌿╽"..Flter_Markdown(redis:get(Titan..'group:name'..msg.chat_id_)).." :\n\n["..GroupLink.."]\n"
...
redis:set(Titan..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Mn3Word = redis:scard(Titan..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*│* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(Titan..':Filter_Word:'..msg.chat_id_)
...
redis:del(Titan..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if not redis:get(Titan..'welcome:msg'..msg.chat_id_) then 
return "📡*╿* اوه ☢ هنالك خطأ 🚸\n♦️╽عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(Titan..'welcome:msg'..msg.chat_id_)
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(Titan..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️│عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(Titan..':Hussain:'..msg.chat_id_)
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(Titan..':MONSHA_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️│عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(Titan..':MONSHA_BOT:'..msg.chat_id_)
...
redis:del(Titan..'banned:'..msg.chat_id_)
return "🙋🏻‍♂*│*أهلا عزيزي "..msg.TheRankCmd.."   \n♦️│ تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local MKTOMEN = redis:scard(Titan..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*│* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(Titan..'is_silent_users:'..msg.chat_id_)
...
redis:del(Titan..'linkGroup'..msg.chat_id_)
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(Titan..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(Titan..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(Titan..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(Titan..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(Titan..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(Titan..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(Titan..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
if redis:get(Titan..'lock_id'..msg.chat_id_) then 
local msgs = redis:get(Titan..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then UserNameID = "@"..data.username_.."" else UserNameID = "" end
local points = redis:get(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(Titan..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local NumGha = (redis:get(Titan..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local Namei = FlterName(data.first_name_..' '..(data.last_name_ or ""),20)
GetPhotoUser(msg.sender_user_id_,function(arg, data)
if redis:get(Titan.."getidstatus"..msg.chat_id_) == "Photo" then
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(Titan..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(Titan..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(Titan..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(Titan..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(Titan..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(Titan..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(Titan..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(Titan..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(Titan..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
redis:del(Titan..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
return "♦️*│*تم مسح {* "..msgs.." *} من رسائلك ☔️\n✓"
end

if MsgText[1]== 'جهاتي' then
return '🧟‍♂*│*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(Titan..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end

if MsgText[1] == 'مسح' and MsgText[2] == 'جهاتي'  then
local adduser = redis:get(Titan..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚠️*│*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(Titan..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
local points = redis:get(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
if points == 0 then  return "⚠️*│*عذرا ليس لديك مجوهرات لكي يتم مسحها" end
redis:del(Titan..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(Titan..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(Titan..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(Titan..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(Titan..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(Titan..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(Titan..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(Titan..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(Titan..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(Titan..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:set(Titan..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(Titan..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(Titan..'welcome:msg'..msg.chat_id_))
else 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."  \n🌿╽نورت المجموعه \n💂🏼‍♀️" 
end 
end
...
local groups = redis:smembers(Titan..'group:ids')
...
local pv = redis:smembers(Titan..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(Titan..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(Titan..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(Titan..':NameBot:')..[[ ✓
...
redis:setex(Titan..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭╿حسننا عزيزي 🍁\n💬╽الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(Titan..':addnumberusers',MsgText[2]) 
return '💱*│* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*│* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(Titan..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
return '📮*│* عدد المجموعات المفعلة » `'..redis:scard(Titan..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
return '🙍🏻‍♂*│*عدد المشتركين في البوت : `'..redis:scard(Titan..'users')..'` \n📡'
end
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if redis:sismember(Titan..'group:ids',MsgText[2]) then
local name_gp = redis:get(Titan..'group:name'..MsgText[2])
...
return redis:get(Titan..":TEXT_SUDO") or '🗃╿لا توجد كليشه المطور .\n📰╽يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if not msg.SudoBase and not redis:get(Titan..'lock_brod') then 
return "📡*│* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(Titan..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(Titan..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(Titan..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(Titan..'fwd:groups'..msg.sender_user_id_,300, true) 
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:del(Titan..'welcom:witting'..msg.sender_user_id_,
Titan..'rulse:witting'..msg.sender_user_id_,
Titan..'rulse:witting'..msg.sender_user_id_,
Titan..'name:witting'..msg.sender_user_id_,
Titan..'about:witting'..msg.sender_user_id_,
Titan..'fwd:all'..msg.sender_user_id_,
Titan..'fwd:pv'..msg.sender_user_id_,
Titan..'fwd:groups'..msg.sender_user_id_,
Titan..'namebot:witting'..msg.sender_user_id_,
Titan..'addrd_all:'..msg.sender_user_id_,
Titan..'delrd:'..msg.sender_user_id_,
Titan..'addrd:'..msg.sender_user_id_,
Titan..'delrdall:'..msg.sender_user_id_,
Titan..'text_sudo:witting'..msg.sender_user_id_,
Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_,
Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/TitanTELLE/Titan.github.io/GetVersion.txt') or 0
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*╿* يوجد تحديث جديد الان \n📡*╽* جاري تنزيل وتثبيت التحديث  ...')
redis:set(Titan..":VERSION",GetVerison)
return false
else
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
return '🎭│الاحصائيات 🏌‍♂ \n\n👥*╿*عدد المجموعات المفعله : '..redis:scard(Titan..'group:ids')..'\n🙍🏻‍♂*╽*عدد المشتركين في البوت : '..redis:scard(Titan..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:setex(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(Titan..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
return "📭│حسننا الان ارسل كلمة الرد العام 🍃\n"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local names 	= redis:exists(Titan..'replay:'..msg.chat_id_)
local photo 	= redis:exists(Titan..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(Titan..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(Titan..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(Titan..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(Titan..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(Titan..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(Titan..'replay:'..msg.chat_id_,Titan..'replay_photo:group:'..msg.chat_id_,Titan..'replay_voice:group:'..msg.chat_id_,
Titan..'replay_animation:group:'..msg.chat_id_,Titan..'replay_audio:group:'..msg.chat_id_,Titan..'replay_sticker:group:'..msg.chat_id_,Titan..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(Titan..'replay:all')
local photo 	= redis:exists(Titan..'replay_photo:group:')
local voice 	= redis:exists(Titan..'replay_voice:group:')
local imation 	= redis:exists(Titan..'replay_animation:group:')
local audio 	= redis:exists(Titan..'replay_audio:group:')
local sticker 	= redis:exists(Titan..'replay_sticker:group:')
local video 	= redis:exists(Titan..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(Titan..'replay:all',Titan..'replay_photo:group:',Titan..'replay_voice:group:',Titan..'replay_animation:group:',Titan..'replay_audio:group:',Titan..'replay_sticker:group:',Titan..'replay_video:group:')
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:set(Titan..'delrdall:'..msg.sender_user_id_,true) 
return "📭╿حسننا عزيزي  ✋🏿\n🗯╽الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:set(Titan..'delrd:'..msg.sender_user_id_,true)
return "📭╿حسننا عزيزي  ✋🏿\n🗯╽الان ارسل الرد لمسحها من  للمجموعه 🍃"
end

if MsgText[1]== 'الردود' then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local names  	= redis:hkeys(Titan..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(Titan..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(Titan..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(Titan..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(Titan..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(Titan..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(Titan..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(Titan..'replay:all')
local photo 	= redis:hkeys(Titan..'replay_photo:group:')
local voice 	= redis:hkeys(Titan..'replay_voice:group:')
local imation 	= redis:hkeys(Titan..'replay_animation:group:')
local audio 	= redis:hkeys(Titan..'replay_audio:group:')
local sticker 	= redis:hkeys(Titan..'replay_sticker:group:')
local video 	= redis:hkeys(Titan..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*│*لا يوجد ردود مضافه حاليا \n💥' 
end
local ii = 1
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:setex(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(Titan..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭│حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
redis:setex(Titan..'namebot:witting'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(Titan..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(Titan..'lave_me'..msg.chat_id_) 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(Titan..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(Titan..'lave_me'..msg.chat_id_,true)  
...
if not msg.SudoBase then return"♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local SubDel = redis:del(Titan..":UserNameChaneel")
if SubDel == 1 then
...
if redis:get(Titan..'welc'..msg.chat_id_) == 'on' then
...
local hash = Titan..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
------set cmd------
Black = msg.text 
mmd = redis:get(Titan..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(Titan..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(Titan..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'🙋🏻‍♂╿اهلا عزيزي \n📡╽تم تثبيت الامر الجديد\n✓')
redis:del(Titan..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(Titan..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(Titan..'CmD:'..msg.chat_id_,cmd)
redis:srem(Titan..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهلا عزيزي\nالامر >"..cmd.."\n📡╽ تم مسحه من قائمه الاوامر\n✓")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
redis:del(Titan..'CmD:'..msg.chat_id_)
redis:del(Titan..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"♦️| اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local CmDlist = redis:smembers(Titan..'CmDlist:'..msg.chat_id_)
local t = '♦️| قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(Titan..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(Titan..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(Titan..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(Titan..'welc'..msg.chat_id_,'off')
redis:del(Titan..'welc'..msg.chat_id_,'on')
else
...
function tophoto(kara,Titan)   
if Titan.content_.ID == "MessageSticker" then        
local bd = Titan.content_.sticker_.sticker_.path_          
...
local msg_pv = tonumber(redis:get(Titan..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(Titan..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛│* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(Titan..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(Titan..'users',msg.sender_user_id_)
if redis:get(Titan..'lock_service') then 
text = [[🤖╿آهلا انآ بــــوت آســمـي   []]..redis:get(Titan..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(Titan.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if not redis:get(Titan..'lock_twasel') then
...
redis:setex(Titan.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group ====================================
if redis:get(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Titan..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Titan..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.text then 
redis:hset(Titan..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
redis:del(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد 🚀 \n-')
elseif msg.photo then 
redis:hset(Titan..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه صوره للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Titan..'replay_voice:group:'..msg.chat_id_,klma,voice_id)
redis:del(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه بصمه صوت للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Titan..'replay_animation:group:'..msg.chat_id_,klma,animation_id)
redis:del(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه متحركه للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Titan..'replay_video:group:'..msg.chat_id_,klma,video_id)
redis:del(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه فيديو للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Titan..'replay_audio:group:'..msg.chat_id_,klma,audio_id)
redis:del(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه للصوت للرد بنجاح ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Titan..'replay_sticker:group:'..msg.chat_id_,klma,sticker_id)
redis:del(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(Titan..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(Titan..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.text then
redis:hset(Titan..'replay:all',klma,Flter_Markdown(msg.text))
redis:del(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'(['..klma..'])\n  ✓ تم اضافت الرد لكل المجموعات 🚀 ')
elseif msg.photo then 
redis:hset(Titan..'replay_photo:group:',klma,photo_id)
redis:del(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه صوره للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.voice then
redis:hset(Titan..'replay_voice:group:',klma,voice_id)
redis:del(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه بصمه صوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(Titan..'replay_animation:group:',klma,animation_id)
redis:del(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه متحركه للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(Titan..'replay_video:group:',klma,video_id)
redis:del(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه فيديو للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(Titan..'replay_audio:group:',klma,audio_id)
redis:del(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه للصوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(Titan..'replay_sticker:group:',klma,sticker_id)
redis:del(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(Titan.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get(Titan.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
if not redis:get(Titan..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'⚠¦ انت منشئ المجموعه ') 
return false
end
local Added_Me = redis:get(Titan.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
if redis:get(Titan..'Added:Me'..msg.chat_id_) then
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تفعيل امر منو ضافني\n✓")
redis:del(Titan..'Added:Me'..msg.chat_id_)  
else
...
if not redis:get(Titan..'Added:Me'..msg.chat_id_) then
redis:set(Titan..'Added:Me'..msg.chat_id_,true)  
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تعطيل منو ضافني\n✓")
else
...
if redis:get(Titan..":ForceSub:"..msg.sender_user_id_) then
if msg.text:match("^@[%a%d_]+$") then
redis:del(Titan..":ForceSub:"..msg.sender_user_id_)
...
redis:set(Titan..":UserNameChaneel",msg.text)
...
if redis:get(Titan..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(Titan..'namebot:witting'..msg.sender_user_id_)
redis:set(Titan..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭╿تم تغير اسم البوت  ✋🏿\n🗯╽الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(Titan..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(Titan..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
redis:hdel(Titan..'replay_photo:group:',msg.text)
redis:hdel(Titan..'replay_voice:group:',msg.text)
redis:hdel(Titan..'replay_animation:group:',msg.text)
redis:hdel(Titan..'replay_audio:group:',msg.text)
redis:hdel(Titan..'replay_sticker:group:',msg.text)
redis:hdel(Titan..'replay_video:group:',msg.text)
redis:setex(Titan..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜╿جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛╽[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(Titan..'delrdall:'..msg.sender_user_id_) then
redis:del(Titan..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(Titan..'replay:all',msg.text)
local photo =redis:hget(Titan..'replay_photo:group:',msg.text)
local voice = redis:hget(Titan..'replay_voice:group:',msg.text)
local animation = redis:hget(Titan..'replay_animation:group:',msg.text)
local audio = redis:hget(Titan..'replay_audio:group:',msg.text)
local sticker = redis:hget(Titan..'replay_sticker:group:',msg.text)
local video = redis:hget(Titan..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*│*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(Titan..'replay:all',msg.text)
redis:hdel(Titan..'replay_photo:group:',msg.text)
redis:hdel(Titan..'replay_voice:group:',msg.text)
redis:hdel(Titan..'replay_audio:group:',msg.text)
redis:hdel(Titan..'replay_animation:group:',msg.text)
...
if redis:get(Titan..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(Titan..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(Titan..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*│* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(Titan..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(Titan..'welcom:witting'..msg.sender_user_id_) 
redis:set(Titan..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*│* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(Titan..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(Titan..'rulse:witting'..msg.sender_user_id_) 
redis:set(Titan..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*╿* مرحبآ عزيزي\n📦│تم حفظ القوانين بنجاح ✓\n🔖╽ارسل [[ القوانين ]] لعرضها \n💬✓')
end
if redis:get(Titan..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(Titan..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(Titan..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(Titan..'linkGroup'..msg.sender_user_id_,link) 
redis:set(Titan..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'🖇│تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(Titan..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(Titan..'about:witting'..msg.sender_user_id_) 
...
if redis:get(Titan..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(Titan..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(Titan..'users')  
local groups = redis:smembers(Titan..'group:ids')
...
if redis:get(Titan..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(Titan..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(Titan..'users')
if #pv >= 300 then
...
if redis:get(Titan..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(Titan..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(Titan..'group:ids')
if #groups >= 300 then
...
if msg.adduser and msg.adduser == our_id and redis:get(Titan..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(Titan..':WELCOME_BOT'),[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(Titan..':NameBot:')..[[ ✓
👨🏻‍✈️│آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛╽مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
if msg.forward_info and redis:get(Titan..'fwd:'..msg.sender_user_id_) then
redis:del(Titan..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(Titan..'users')
local groups = redis:smembers(Titan..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(Titan..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(Titan..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(Titan..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'🚸│تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(Titan..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(Titan..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(Titan..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(Titan..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
redis:hdel(Titan..'replay:'..msg.chat_id_,msg.text)
redis:hdel(Titan..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(Titan..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(Titan..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(Titan..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(Titan..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(Titan..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(Titan..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜╿جيد , يمكنك الان ارسال جواب الرد \n🔛╽[[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]]\n✓")
end
end

if redis:get(Titan..'delrd:'..msg.sender_user_id_) then
redis:del(Titan..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(Titan..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(Titan..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(Titan..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(Titan..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(Titan..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(Titan..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(Titan..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'💬*│*هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(Titan..'replay:'..msg.chat_id_,msg.text)
...
if msg.pinned then
print(" -- pinned -- ")
local msg_pin_id = redis:get(Titan..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and redis:get(Titan..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(Titan..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(Titan..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if redis:get(Titan..'mute_tgservice'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_)
else
if redis:get(Titan..'welcome:get'..msg.chat_id_) then 
if not msg.adduserType then
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(Titan..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂│اهلن بك عزيزي {الاسم}\n🎟│معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜│اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(Titan..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻╿مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️│ممنوع نشر الروابط\n⚠️│ممنوع التكلم او نشر صور اباحيه\n⚔│ممنوع  اعاده توجيه\n💭│ممنوع التكلم بلطائفه\n♥️╽الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(Titan..'group:name'..msg.chat_id_) or '')))
...
--------------------------------------------
if msg.adduser and redis:get(Titan..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(Titan..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(Titan..'welcome:get'..msg.chat_id_)
end
redis:setex(Titan..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if not msg.Admin and not msg.Special and not (msg.adduser or msg.joinuser or msg.deluser ) then -- للاعضاء فقط   

if not msg.forward_info and redis:get(Titan..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(Titan..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_Titan = (redis:get(Titan..'num_msg_Titan'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_Titan) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(Titan..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"🙍🏻‍♂╿العضو » "..USERNAME.."\n🚸╽قمـت بتگرآر آگثر مـن "..NUM_MSG_Titan.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
redis:setex(Titan..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end
...
if redis:get(Titan..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(Titan..'lock_woring'..msg.chat_id_) and not redis:get(Titan..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(Titan..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(Titan..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(Titan..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
print("\27[1;31m Msg Del becuse send inline \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*╿* لا يمكنني مسح الرساله المخالفه .\n🎟*╽* لست مشرف او ليس لدي صلاحيه  الحذف \n 💥')    
end
if redis:get(Titan..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(Titan..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Titan..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Titan..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(Titan..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(Titan..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(Titan..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(Titan..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(Titan..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(Titan..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(Titan..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.photo then
if redis:get(Titan..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Titan..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.video then
if redis:get(Titan..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Titan..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(Titan..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(Titan..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.animation then
if redis:get(Titan..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(Titan..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(Titan..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(Titan..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(Titan..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(Titan..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(Titan..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(Titan..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(Titan..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(Titan..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(Titan..'replay'..msg.chat_id_) then

local Replay = false

 Replay = redis:hget(Titan..'replay:all',msg.text)
if Replay then
sendMsg(msg.chat_id_,msg.id_,Replay)
return false
end

 Replay = redis:hget(Titan..'replay:'..msg.chat_id_,msg.text)
if Replay then 
 sendMsg(msg.chat_id_,msg.id_,Replay) 
return false
end
 Replay = redis:hget(Titan..'replay_photo:group:',msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_voice:group:',msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Titan..'replay_animation:group:',msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_audio:group:',msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_sticker:group:',msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_video:group:',msg.text)
if Replay then 
print("0000000000000") 
...
Replay = redis:hget(Titan..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendPhoto(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVoice(msg.chat_id_,msg.id_,Replay)
return false
end

Replay = redis:hget(Titan..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAnimation(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendAudio(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(Titan..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
 sendVideo(msg.chat_id_,msg.id_,Replay)
return false
end
...
if redis:get(Titan..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(Titan..'ExpireDate:'..msg.chat_id_)
if not ExpireDate and not msg.SudoUser then
rem_data_group(msg.chat_id_)
sendMsg(SUDO_ID,0,'🕵🏼️‍♀️╿انتهى الاشتراك في احد المجموعات ✋🏿\n👨🏾‍🔧│المجموعه : '..FlterName(redis:get(Titan..'group:name'..msg.chat_id_))..'🍃\n💂🏻‍♀️╽ايدي : '..msg.chat_id_)
sendMsg(msg.chat_id_,0,'🕵🏼️‍♀️╿انتهى الاشتراك البوت✋🏿\n💂🏻‍♀️│سوف اغادر المجموعه فرصه سعيده 👋🏿\n👨🏾‍🔧╽او راسل المطور للتجديد '..SUDO_USER..' 🍃')
return StatusLeft(msg.chat_id_,our_id)
else
local DaysEx = (redis:ttl(Titan..'ExpireDate:'..msg.chat_id_) / 86400)
